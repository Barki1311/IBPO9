xmlport 67002 "UTT O9SupplierDim"
{
    Caption = 'UTT O9SupplierDim';
    Format = VariableText;
    Direction = Export;
    TextEncoding = UTF8;
    UseRequestPage = false;
    FileName = 'IVMK_SupplierDim.dsv';
