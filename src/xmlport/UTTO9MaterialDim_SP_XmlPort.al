xmlport 67019 "UTT O9MaterialDim_SP"
{
    Caption = 'UTT O9 MAterialDim_SP';
    Format = VariableText;
    Direction = Export;
    TextEncoding = UTF8;
    UseRequestPage = false;
    FileName = 'IVMK_MaterialDim_SP.dsv';
    ...
    EntryNo: Integer;
            ...
            tableelement(Item; Item)
            {
                ...
                { 
                    ...
                    begin
                        Weight := 'N/A';
                        IBPO9Buffer."Field 20" := format(item."Net Weight",0, 9);
                        IBPO9Buffer.Modify();
                    end;
                }
